-- SKIDDED BY SIGMA @rizzify101 | Accurate Dinosaur, Primal & Zen Egg Support
local Players = game:GetService("Players")
local PlayerGui = Players.LocalPlayer:WaitForChild("PlayerGui")

-- ðŸ£ Egg-to-Pet mapping with full wiki lists
local eggToPets = {
...
-- ðŸŽ¯ Weighted random selection to honor actual hatch chances
...
-- ðŸ” Randomize ESP across workspace eggs
...
title.Text = "Pet Changer, SKIDDED BY SIGMA @rizzify101"
...
-- â±ï¸ 3-second cooldown before re-randomize
local cooling = false
